...
{
    public class AddProductBatchFromExcel : IAddProductBatchFromExcel
    {
        private IConfiguration configuration;
        private IWebHostEnvironment webHostEnvironment;
        public AddProductBatchFromExcel(IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public void ImportProductBatch(DataTable productBatch)
        {
            ...
            using (SqlConnection scon = new SqlConnection(sqlconn))
            {
                ...
                {
                    sqlBulkCopy.DestinationTableName = "ProductBatches";
                    foreach (DataColumn column in productBatch.Columns)
                    {
                        // Ánh xạ cột
                        sqlBulkCopy.ColumnMappings.Add(column.ColumnName, column.ColumnName);
                    }
                    sqlBulkCopy.WriteToServer(productBatch);
                }
        ...
        public DataTable ProductBatchDataTable(string path)
        {
